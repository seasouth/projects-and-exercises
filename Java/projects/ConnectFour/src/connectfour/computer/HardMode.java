...
public class HardMode {
    ...
    public static int bestColumn(Board board) {
        ...
        int topOfPyramid = topOfPyramid(board);
    ...
    /**
     * While playing against myself I found it helpful to block potential diagonal wins by being on top of a pyramid shape of pieces,
     * so I wrote a method to check for that.
     */
    private static int topOfPyramid(Board board) {
        int inARow = 0;
            ...
            for (int j = board.getBoard()[i].length - 1; j >= 0; j--) {
                if (board.getBoard()[i][j] != null) {
                    ...
                    while (count >= 0) {
                        ...
                        if (inARow >= 2) {
                            if (i >= 2 && j >= 3) {
                                if (board.getBoard()[i - 2][j] == null && board.getBoard()[i][j - 2] == null) {
